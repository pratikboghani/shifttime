...
class AdminSettingScreen extends StatefulWidget {
  @override
  State<AdminSettingScreen> createState() => _UserSettingScreenState();
}

class _UserSettingScreenState extends State<AdminSettingScreen> {
  @override
...
class AdminInfoScreen extends StatefulWidget {
  @override
  _AdminInfoScreenScreenState createState() => _AdminInfoScreenScreenState();
}

class _AdminInfoScreenScreenState extends State<AdminInfoScreen> {
  @override
  void initState() {
    super.initState();
          ...
          ? Column(
              ...
              children: [
                ...
                UserInfoCard(
                  ...
                  data: {
                    'Subscription Type':
                        userData['subscription'].toString(),
                    'Expiry':
                        userData['subscription'].toString(),
                  },
                ),
